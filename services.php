...
<div class="Services-area area-padding">
            ...
            <div class="services-all">
                    ...
                    <div class="single-services text-center">
                        ...
                        <div class="main-services">
                            <div class="service-content">
                                ...
                                <a class="service-btn" href="logistics.php">read more</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-services text-center">
                        ...
                        <div class="main-services">
                            <div class="service-content">
                                <h4>Car Loading</h4>
                                <p> We typically offer a range of services aimed at facilitating smooth relocation for individuals and businesses.</p>
                                <a class="service-btn" href="carloading.php">read more</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-services text-center">
                        ...
                        <div class="main-services">
                            <div class="service-content">
                                ...
                                <p> We typically offer a range of services aimed at facilitating smooth relocation for individuals and businesses.</p>
                                <a class="service-btn" href="cargoservices.php">read more</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="single-services text-center">
                        ...
                        <div class="main-services">
                            <div class="service-content">
                                <h4>Goods/Luggage Transport</h4>
                                <p> We typically offer a range of services aimed at facilitating smooth relocation for individuals and businesses.</p>
                                <a class="service-btn" href="luggagegoodstranport.php">read more</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-services text-center">
                        ...
                        <div class="main-services">
                            <div class="service-content">
                                <h4>Air Cargo</h4>
                                <p> We typically offer a range of services aimed at facilitating smooth relocation for individuals and businesses.</p>
                                <a class="service-btn" href="aircargo.php">read more</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="single-services text-center">
        ...
        <div class="main-services">
            <div class="service-content">
                <h4>Domestic Cargo</h4>
                <p> We typically offer a range of services aimed at facilitating smooth relocation for individuals and businesses.</p>
                <a class="service-btn" href="domesticcargo.php">read more</a>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="single-services text-center">
                        ...
                        <div class="main-services">
                            <div class="service-content">
                                <h4>Freight Cargo</h4>
                                <p> We typically offer a range of services aimed at facilitating smooth relocation for individuals and businesses.</p>
                                <a class="service-btn" href="freightcargo.php">read more</a>
                            </div>
                        </div>
                    </div>
                </div>
