    ...
    <div class="intro-carousel">
        <div class="intro-content">
            <div class="slider-images">
                <img src="img/background/banner1.jpeg" alt="">
            </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <!-- layer 1 -->
                                    <div class="layer-1-2">
                                        <h1 class="title2"><span style="color:red;">VRL</span> <br><span style="font-size:25px;"> Freight Cargo</span></h1>
                                    </div>
                                    <div class="layer-1-1 ">
        ...
        <div class="intro-content">
            <div class="slider-images">
                <img src="img/background/packer3.jpeg" alt="">
            </div>
            <div class="slider-content">
                <div class="display-table">
                    <div class="display-table-cell">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="video-inner text-center">
                    <div class="video-content">
                        ...
                        <img class="video-content" src="img/background/packer3.jpeg" alt="">
                    ...
                    <div class="single-services text-center">
                        ...
                        <div class="main-services">
                            <div class="service-content">
                                ...
                                <a class="service-btn" href="home_relocation.php">read more</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-services text-center">
                        ...
                        <div class="main-services">
                            <div class="service-content">
                                ...
                                <p> We typically offer a range of services aimed at facilitating smooth relocation for individuals and businesses.</p>
                                <a class="service-btn" href="Door_to_Door.php">read more</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-services text-center">
                        ...
                        <div class="main-services">
                            <div class="service-content">
                                ...
                                <p>We typically offer a range of services aimed at facilitating smooth relocation for individuals and businesses.</p>
                                <a class="service-btn" href="transportation.php">read more</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="Services-area area-padding1">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="banner-content text-left">
                    <h4>Are you looking for more professional Services for relocation?</h4>
                    <div class="banner-contact-btn">
                        <a class="banner-btn" href="services.php">Click Here</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="client-details">
                    <div class="client-head">
                        <h3>Our valuable Data</h3>
                        <p>This data shows our customer's satisfaction , our staff number , our projects and our branches. </p>
                    </div>
                ...
                <div class="company-content">
                    <div class="main-view">
                        <div class="single-view">
                            ...
                            <div class="view-content">
                                ...
                                <p> Skilled professional dedicated to ensuring the smooth and efficient relocation of goods with attention to detail and safety.</p>
                            </div>
                        </div>
                    </div>
                    <!-- End single-view -->
                    ...
                    <div class="main-view">
                        <div class="single-view">
                            ...
                            <div class="view-content">
                                <h4>Low Costing</h4>
                                <p> Choosing off-peak moving dates, and comparing quotes from multiple affordable packers and movers, we provide the best value for your budget.</p>
                            </div>
                        </div>
                    </div>
                    <!-- End single-view -->
                    <div class="main-view">
                        <div class="single-view">
                            ...
                            <div class="view-content">
                                ...
                                <p> Our service guarantees timely completion of your move, ensuring that all your belongings are safely transported and delivered to your new location.</p>
                            </div>
                        </div>
                    </div>
                    <!-- End single-view -->
...
<div class="container pb-40 pt-30 " style="padding-top:50px; padding-bottom:50px;">
    ...
    <div class="row">
        <div class="col-lg-3 col-md-6">
            <ul class="requirements-list" style="font-size: 14px;font-weight: 500;">
                <li><a href="dehradun.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Dehradun</a></li>
                <li><a href="gandhinagar.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Gandhinagar</a></li>
                <li><a href="goa.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Goa</a></li>
                <li><a href="gurgaon.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Gurgaon</a></li>
                <li><a href="guwahati.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Guwahati</a></li>
                <li><a href="hyderabad.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Hyderabad</a></li>
                <li><a href="indore.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Indore</a></li>
                <li><a href="jaipur.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Jaipur</a></li>
                <li><a href="jamnagar.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Jamnagar</a></li>
            </ul>
        </div>
        <div class="col-lg-3 col-md-6">
            <ul class="requirements-list list-group list-group-flush" style="font-size: 14px;font-weight: 500;">
                <li><a href="ahmedabad.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Ahmedabad</a></li>
                <li><a href="angul.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Angul</a></li>
                <li><a href="bhubaneswar.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Bhubaneswar</a></li>
                <li><a href="bangalore.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Bangalore</a></li>
                <li><a href="balasore.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Balasore</a></li>
                <li><a href="chandigarh.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Chandigarh</a></li>
                <li><a href="chennai.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Chennai</a></li>
                <li><a href="cuttack.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Cuttack</a></li>
                <li><a href="delhi.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Delhi</a></li>
            </ul>
        </div>
        <div class="col-lg-3 col-md-6">
            <ul class="sitemap-widget" style="font-size: 14px;font-weight: 500;">
                <li><a href="pune.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Pune</a></li>
                <li><a href="raipur.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Raipur</a></li>
                <li><a href="ranchi.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Ranchi</a></li>
                <li><a href="rourkela.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Rourkela</a></li>
                <li><a href="thiruvananthapuram.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Thiruvananthapuram</a></li>
                <li><a href="vapi.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Vapi</a></li>
                <li><a href="vijayawada.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Vijaywada</a></li>
                <li><a href="vizag.php"><i class="fa fa-caret-right" style="color:red;" aria-hidden="true"></i> Packers and Movers to Vizag</a></li>
            </ul>
        </div>
        <div class="col-lg-3 col-md-6">
            <ul class="requirements-list" style="font-size: 14px;font-weight: 500;">
                            ...
                            <div class="panel-group" id="accordion">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="check-title">
                                            <a data-toggle="collapse" class="active" data-parent="#accordion" href="#check1">
                                                <span class="acc-icons"></span>What services do we offer?
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="check1" class="panel-collapse collapse in">
                                        <div class="panel-body">
                                            <p>
                                                We typically offer a range of services including packing, loading, transportation, unloading, unpacking, storage, and sometimes additional services like pet relocation or vehicle transportation.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="check-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#check2">
                                                <span class="acc-icons"></span>How far in advance should I book packers & movers?
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="check2" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <p>
                                                It's advisable to book as early as possible, ideally at least a few weeks in advance, especially during peak moving seasons or for long-distance moves. This ensures availability and gives you time to plan and prepare. </p>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Panel Default -->
